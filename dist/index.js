...
exports.createNestedMiddleware = exports.init = void 0;
// @ts-ignore ..
...
function extractWriteInfo(params, model, argPath) {
    const arg = (0, get_1.default)(params.args, argPath, {});
...
exports.init = init;
function createNestedMiddleware(middleware) {
    ...
    const nestedMiddleware = async (params, next) => {
        ...
        if (writeOperationsSupportingNestedWrites.includes(params.action)) {
            relations.forEach((relation) => extractNestedWriteInfo(params, relation).forEach((nestedWriteInfo) => {
                ...
                const result = nestedMiddleware(nestedWriteInfo.params, (updatedParams) => {
                    ...
                    (0, set_1.default)(finalParams.args, `${nestedWriteInfo.argPath}.${updatedParams.action}`, updatedParams.args);
        ...
        try {
            ...
            await Promise.all(nestedWrites.map(async (nestedWrite) => {
                ...
                const nestedResult = (0, get_1.default)(result, nestedWrite.relationName);
                ...
                (0, set_1.default)(result, nestedWrite.relationName, await nestedWrite.result);
            }));
            return result;
        }
        catch (e) {
...
exports.createNestedMiddleware = createNestedMiddleware;
